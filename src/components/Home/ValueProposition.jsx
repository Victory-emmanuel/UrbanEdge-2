...
const ValueProposition = () => {
  return (
    <section className="py-16 bg-white dark:bg-brown-dark" data-oid="_oycv_8">
      <div className="container mx-auto px-4" data-oid="iv:s1i1">
        <SectionHeading
        ...
        <div
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 xs:gap-6 sm:gap-8 mt-8 xs:mt-10 sm:mt-12"
          data-oid="q2ukpja"
        >
          {features.map((feature, index) => (
            ...
            >
              <div
                className="text-taupe mb-3 xs:mb-4 mx-auto"
                data-oid="_uvi6ma"
              >
                <div
                  className="w-8 h-8 xs:w-10 xs:h-10 mx-auto"
                  data-oid="2imql51"
                >
                  {feature.icon}
                </div>
              ...
              <h3
                className="text-lg xs:text-xl font-heading font-bold mb-2 xs:mb-3 text-brown-dark dark:text-beige-light"
                data-oid="qw_bgw."
              >
                {feature.title}
              </h3>
              <p
                className="text-sm xs:text-base text-brown dark:text-beige-medium"
                data-oid="rr0wdvv"
              >
                {feature.description}
              </p>
