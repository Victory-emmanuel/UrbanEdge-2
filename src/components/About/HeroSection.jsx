...
const HeroSection = () => {
  return (
    <section className="relative py-20 md:py-32" data-oid="ww60dq6">
      {/* Background Pattern */}
      <div
        className="absolute inset-0 z-0 bg-beige-light dark:bg-brown overflow-hidden"
        data-oid="urp8.20"
      >
        <div
      ...
      <div className="container mx-auto px-4 relative z-10" data-oid="xnt2:3s">
        <div className="max-w-3xl mx-auto text-center" data-oid="0r1_5kb">
          <motion.h1
